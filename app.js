...
var server = http.createServer(function (req, res) {
  let u = ['/', '/index'].indexOf(url.parse(req.url).pathname) !== -1 ? '/index.html' : url.parse(req.url).pathname;

  var filename = __dirname + '/dist' + u;
...
server.listen('9998', function () {
  console.log('server start on: ' + getIPv4() + ':9998');
})